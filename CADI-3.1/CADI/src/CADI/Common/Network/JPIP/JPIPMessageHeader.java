 ...
 */
public class JPIPMessageHeader implements ClassIdentifiers {
	 ...
	 * identifier foun within the Bin-ID VBAS.
	 */
	public int Aux = -1;
	 ...
	 */
	public int EORCode = -1;		// TODO: the inClassIdentifier could be used as a EORCode
	 ...
	 */
	public String EORReasonMessage = null;
	 ...
	 */
	public JPIPMessageHeader(int CSn, int classIdentifier, long inClassIdentifier,
	                         long msgOffset, long msgLength,
	                         boolean isLastByte, int Aux) {
		this.isEOR = false;
		this.CSn = CSn;
	 ...
	 * Constructor.
	 * 
	 * @param jpipMessageHeader an object of this class
	 */
	public JPIPMessageHeader(JPIPMessageHeader jpipMessageHeader) {
		this.isEOR = jpipMessageHeader.isEOR;
		if (jpipMessageHeader.isEOR) {
			this.EORCode = jpipMessageHeader.EORCode;
			this.msgLength = jpipMessageHeader.msgLength;
		} else {
			this.CSn = jpipMessageHeader.CSn;
			this.classIdentifier = jpipMessageHeader.classIdentifier;
			this.inClassIdentifier = jpipMessageHeader.inClassIdentifier;
			this.msgOffset = jpipMessageHeader.msgOffset;
			this.msgLength = jpipMessageHeader.msgLength;
			this.isLastByte = jpipMessageHeader.isLastByte;
			this.Aux = jpipMessageHeader.Aux;
		}
	}
	 ...
	 * 
	 * @param EORCode
	 * @param EORReasonMessage
	 */
	public JPIPMessageHeader(int EORCode, String EORReasonMessage) {
		this.isEOR = true;
		this.EORCode = EORCode;
		this.EORReasonMessage = EORReasonMessage;
	}
  ...
  @Override
	...
	public void list(PrintStream out) {
		...
		if (!isEOR) {
			out.println("CSn: "+CSn);
			out.println("ClassIdentifier: "+classIdentifier);
