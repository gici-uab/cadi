...
public class ChannelField {
	 ...
	 */
	public ArrayList<String> cnew = null;
	 ...
	 */
	public ArrayList<String> cclose = null;
	...
	public String toString() {
		...
		if (cclose != null) {
			...
			for (int i = 0; i < cclose.size(); i++) {
				str += cclose.get(i) + (i==cclose.size()-1 ? "" : ",");
			}
		}		
		str += "]";
		return str;
	...
	public void list(PrintStream out) {
		...
		if (cclose != null) {
			out.print("cclose: ");
			for (int i = 0; i < cclose.size(); i++) {
				out.print(cclose.get(i) + (i==cclose.size()-1 ? "" : " "));
			}
			out.println();
		}		
