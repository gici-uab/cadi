...
public class ServerControlField implements ImageReturnTypes {
	 ...
	 * 
	 */
	public boolean useExtendedHeaders = false;
  ...
  @Override
	public String toString() {
		...
		str += ", use extended headers = "+useExtendedHeaders;

		if (drate >= 0) str += ", drate=" + drate;
	...
	public void list(PrintStream out) {
		...
		out.println("Use extended headers:"+useExtendedHeaders);

		if (drate >= 0) out.println("drate: " + drate);
