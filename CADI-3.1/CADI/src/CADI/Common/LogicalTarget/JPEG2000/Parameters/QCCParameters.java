...
/**
 * This class storages the quantization default (QCC).
 * 
 * Further and detailed information, see ISO/IEC 15444-1 section A.6.5.
 * 
 * @author Group on Interactive Coding of Images (GICI)
 * @version 1.0 2010/11/19
 */
public class QCCParameters {
	 ...
	 *   </ul>
	 */
	public int quantizationStyle = -1;	// The legacy name was QTypes
	 ...
	 */
	public int guardBits = -1;
	
	// ============================= public methods ==============================
	/**
	 * Constructor.
	 */
	public QCCParameters() {
	 ...
	 */
	public QCCParameters(QCCParameters parameters) {
		...
		for (int r = 0; r < exponents.length; r++) {
			exponents[r] = Arrays.copyOf(parameters.exponents[r], parameters.exponents[r].length);
			mantisas[r] = Arrays.copyOf(parameters.mantisas[r], parameters.mantisas[r].length);
		}
  ...
  @Override
	...
	public void list(PrintStream out) {
		...
		for (int r = 0; r < exponents.length; r++) {
			...
			out.print(r < (exponents[r].length-1) ? ", ": "}");
		}
		out.println();
		...
		for (int r = 0; r < mantisas.length; r++) {
			...
			out.print(r < (mantisas[r].length-1) ? ", ": "}");
		}
		out.println();
