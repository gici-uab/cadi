 ...
 * saved and then they are readed by the <code>RequestDispatcher</code>
...
public class RequestQueue {
	...
	/**
	 * Contains a list of the client request. The <data>ArrayList</data> is not
	 * a synchronized data list, so the class methods implement the concurrence
	 * to avoid simultaneous access.
	 */
	private ArrayList<RequestQueueNode> queue = null;
	 ...
	 */
	public RequestQueue(){
		queue = new ArrayList<RequestQueueNode>();
	}
	 ...
	 * @param nodeInfo
	 */
	public synchronized void add(RequestQueueNode nodeInfo) {
		queue.add(nodeInfo);
		notify();
	}
	 ...
	 */
	public synchronized RequestQueueNode get() throws InterruptedException {
